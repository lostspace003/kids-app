...
// child's name, Ghibli avatar, and age (whole completed years). English (the
// journey language is chosen per-prophet, so there's no toggle here).
      ...
      <Card style={{ textAlign: "center" }}>
        ...
        {age != null && (
          <p style={{ color: C.ink, fontSize: 16, margin: "0 0 4px" }}>
            You are <strong style={{ color: C.gold }}>{age}</strong> {age === 1 ? "year" : "years"} old — mashaAllah! 🎉
          </p>
        )}
        <p style={{ color: C.dim, fontSize: 14.5, margin: "8px 0 22px", lineHeight: 1.5 }}>
          Take your lantern in hand, dear. A journey of light through the lives of the prophets awaits you. ✨
        </p>
